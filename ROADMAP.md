...
- **[TSK-185] Pano build ölü artefakt birikimi — `vite` `emptyOutDir: false`, eski hash'li js/css depoda izli kalıyor (~4 js + 3 css, ~8,4 MB) ve dağıtımla canlıya gidiyor; manifest birini işaret ediyor** — status: QUEUED · born: 2026-09-13 · owner: rol1 · size: S · trigger: —
