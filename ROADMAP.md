...
- (bkz. **TSK-086** — İNFRA-SİMETRİ ikinci bacak [eski anılış "TSK-005 2. bacak"]: `/api/infra.beklenmedik_birimler` alanına pano okuyucusu — Altyapı kartına rozet + liste; Yasa 6 borcu. İcra burada.)
...
- **[TSK-088] Model kayıt bileşeni — LLM seçimi/rota/sağlık tek kaynakta** — status: DONE(2026-09-01·hüküm: tek-kapı APISIX — ardıl TSK-089/TSK-090) · born: 2026-09-01 · owner: rol1 · size: M · trigger: —
  ...
  Ref: TSK-020 (backend mimari kararları — bu madde o dizinin 10. kalemi olarak da sıralanabilir) · TSK-047 canary kaydı · ardıl: TSK-089, TSK-090. _(eski: §3)_
