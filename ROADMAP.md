...
- **[TSK-113] Pano `Kapi` üç-hâl kapısının yedi kopyası tek kaynağa iner** — status: ACTIVE · born: 2026-09-03 · owner: rol1 · size: S · trigger: —
...
- **[TSK-114] v323 `teknik` çivisi çağrı yerlerini görmüyor — `Olculemedi` kullanım-yeri kapsaması** — status: ACTIVE · born: 2026-09-03 · owner: rol1 · size: S · trigger: —
...
- **[TSK-092] Dağıtım reçetesi birim istenen-durum koruması — start satırı sabit üçlü paket olamaz** — status: ACTIVE · born: 2026-09-01 · owner: rol1 · size: S · trigger: —
