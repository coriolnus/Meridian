...
- **[TSK-183] `meridian/olaylar.py::_SERTLESTIRME` DuckDB bağlantısı tavansız — API/bekçi okuyucusu (`tum_olaylar`) canlı işçide sınırsız bellekle koşuyor; `ops/olay_sorgu.py` (2GB, b081ab6) ve `sohbet.py` (512MB) tavanlıyken üçüncü kopya açık** — status: QUEUED · born: 2026-09-13 · owner: rol1 · size: S · trigger: —
