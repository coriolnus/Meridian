...
- **[TSK-052] A·PIT/veri (EDG-062)** — status: ACTIVE · born: 2026-08-31 · owner: rol1 · size: M · trigger: —
  What: PIT ihlal düzeltmesinin (b) yolu (EDG-2026-062) uçuşta; inişi TSK-011 (cf tarama kuyruğu) ve TSK-059 (B·P-2/`ts` kart uygulaması, akıbet kararlarına göre) için tetikleyicidir.
...
- **[TSK-058] Skill-görüş dalgası — EDG-019 uygulaması + EDG-063 LLM-üretici sınıfı** — status: ACTIVE(implementasyon İNDİ 2026-09-01: kuyruk+LLM üreticisi + 2 fix turu, SDD tam döngü, 16/16 mutasyon kanıtı; KALAN=FAZ C: bayrak açılışı + `meridian-skill-gorus.timer` dağıtımı + ilk canlı koşum + kart kayıtları — seans-dışı pencere) · born: 2026-08-31 · owner: rol1 · size: M · trigger: —
...
- **[TSK-059] B·P-2/`ts` kart uygulaması** — status: GATED(TSK-052 [EDG-062 (b) bacağı] inişinden sonra) · born: 2026-08-31 · owner: rol1 · size: M · trigger: EDG-062(b) inişi
...
- **[TSK-089] APISIX tek-kapı pilotu — LLM + veri API'leri tek kapıdan** — status: GATED(operatör kurulum izni) · born: 2026-09-01 · owner: rol1 · size: L · trigger: operatör "kur" onayı ("kuruluma hemen geçme" yürürlükte)
...
- **[TSK-090] Kapı sayfası — pano'da APISIX'in tam yüzeyi** — status: GATED(TSK-089 Faz 1) · born: 2026-09-01 · owner: rol1 · size: M · trigger: TSK-089 Faz 1 inişi
...
- **[TSK-020] backend mimari kararları — 9 kalem; sıra REVİZE (operatör 2026-09-01 gece): `4→2-adım2→3→1→9` (eski `8→4→2→1→3→9`; UYGULA-8 DONE, `2-adım1` İLK SIRA araya-kalem bloğuna alındı)** — status: QUEUED · born: 2026-08-31 · owner: rol1 · size: L · trigger: —
  ...
  · [UYGULA-2] DuckDB analitik — adım 1 **DONE (2026-09-01):** `ops/olay_sorgu.py` (ozet/son/tip + yalnız-SELECT `--sql`, bozuk-satır sayımı stderr'e, meridian-import'suz, sertleştirilmiş bağlantı) + v355 36 çivi; adım 2 aylık Parquet sıkıştırma SIRADA; boyut orta.
...
- **[TSK-094] TSX satır-çapalarının sembol-çapaya göçü** — status: QUEUED · born: 2026-09-01 · owner: rol1 · size: S · trigger: —
...
- **[TSK-093] Skill-görüş karışık-üretici ileri kalemleri** — status: DORMANT · born: 2026-09-01 · owner: rol1 · size: S · trigger: bir skill'in hem det hem llm satır taşımaya başlaması (uretici_kirilimi'nde aynı skill iki kovada)
