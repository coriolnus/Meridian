...
- **[TSK-186] EDG-067 haftalık taban tazelemesi A1'de DÜŞÜYOR — `manifest_uret.py` git ister, `/opt/meridian/.git` YOK (Ansible rsync 2026-09-08'den beri); docs arama korpusu (TSK-167 `/api/arama`) 09-06'da donmuş** — status: ACTIVE · born: 2026-09-13 · owner: rol1 · size: S · trigger: —
