...
- **[TSK-151] ingest067 'sarılı günlük-429' HTTP 500 gövdesinde geliyor → `gecici_hata` sayılıp 3×200 s boşa deneniyor; `dur` sınıfı olmalı** — status: QUEUED · born: 2026-09-05 · owner: rol1 · size: S · trigger: —
  What: TSK-144 keşfi: r2'de 14 dilim kota dolduktan sonra (10:33:49Z) HTTP 500 'Fact extraction failed … RateLimitError/free-models-per-day' gövdesiyle düştü; hata_sinifi bunu geçici saydı → 42 çağrı / 47 dk boşa. İş: hata_sinifi 500 gövdesinde 'free-models-per-day'/'RateLimitError' görünce `dur` döner; v387 tablosuna satır + mutasyon; A1 kopyası (sha eşit — deploy dışı yol, F9'a ekle); r3 (09-06 00:05Z) öncesi girmesi şart değil, sonraki koşumdan önce.
