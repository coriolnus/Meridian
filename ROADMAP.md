...
| `23d` bar-içi stop varsayımı (stop slipajı SIFIR) | WP1 | **H0→H1: KART ÖN-KAYITLI `EDG-2026-045`** (K=3: stop-bacağı ek-slip {5,10,20} bps, edg040 deseni; 23b mutabakatı kartta — gerçek-dolum tarafı 042-K3'te, iki kaynaklı okuma; stop_gap'e sızma kill'de) |
