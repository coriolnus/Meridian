...
- **[TSK-066] ⑥a — mevcut sinyallerin AN yeniden-kurulumu** — status: QUEUED · born: 2026-08-31 · owner: rol1 · size: M · trigger: —
  What: (DÜZELTME 01:08Z: EDG-079'un survivorship hükmü bu kaleme (tick AN yeniden kurulumu) değil YENİ kalem [TSK-159]'a aittir — evren PIT'siz olduğu için bu kalemin sinyal kümesi de survivorship şerhlidir; TSK-159 önce.) (status notu 2026-09-03 gece: KART YAZILDI — EDG-2026-069, §6; ONAY 2026-09-03 sabah [K2], ölçüm kodu KOVA C sırasında.) sinyal hangi saniyede doğdu, icraya kadar fiyat ne yaptı (EDG-040 friksiyon sorusunun tick bacağı). Kartı geri-dolumun 2.-3. günü erken yazılır (PARALEL not, yukarıda).
...
- **[TSK-154] Wikipedia S&P 500 sayfasındaki 'Selected changes' tablosu kalktı → `constituents.as_of` PIT iskelesi sessizce kör; önbellek 11 hayalet boş satır yazıyor** — status: QUEUED · born: 2026-09-05 · owner: rol1 · size: S · trigger: —
...
- **[TSK-162] Oturum başı arıza triyajında Hindsight recall — "bu alarm daha önce öttü mü, ne yaptık?" sorusu vaka arşivine (grep'in tamamlayıcısı)** — status: QUEUED · born: 2026-09-06 · owner: rol1 · size: S · trigger: —
  What: Triyaj adımına (oturum-basi-canli-triyaj) A1 `~/bin/hafiza_sor.sh "<alarm/arıza>" 5 meridian-arsiv low` çağrısı; cevaptaki çapa dosyada doğrulanır (uydurma yasağı). Ölçüt: 2 hafta boyunca triyajda kaç kez kaynak gösterildi / kaç kez grep'in bulamadığını buldu (günlükte 'kaynak: recall' atfı). Kod yok; disiplin + sayım.
...
- **[TSK-163] Bot ikinci görüşü — BOT RECALL kartı (tasarım §3: derlenmiş-sayfa / provider-autoRecall / hafızasız taban, üç kol)** — status: GATED(EDG-083 GEÇTİ ∧ EDG-067 hükmü) · born: 2026-09-06 · owner: rol1 · size: M-L · trigger: EDG-2026-083 hükmü GEÇTİ ∧ EDG-2026-067 recall taban-kıyası hükmü (Türkçe çivisi dahil)
  What: Şef/bekçi/karne botlarına kendi geçmiş teslimleri + öneri akıbetleri derlenmiş sayfa olarak (harness derler, bot yazmaz); pull tek araç hindsight_recall (salt-okuma); teslimde KULLANIM BEYANI; gölge A/B geçmeden canlıya açılmaz. Ölçüt: mükerrer öneri oranı ve öneri akıbeti isabeti (tasarım §5 taslağı).
...
- **[TSK-164] Öneri akıbeti defteri sayfası — öneri → karar → sonuç zinciri (zihin modeli, talep üzerine)** — status: GATED(EDG-083 GEÇTİ) · born: 2026-09-06 · owner: rol1 · size: S · trigger: EDG-2026-083 hükmü GEÇTİ (2026-09-13)
  What: Dördüncü sayfa: "açık öneriler ve akıbetleri" (bankadaki karar/kart gözlemlerinden); uydurma sayacı aynı; okuyucu Rol-1 + pano. Boş/yanlış çıkarsa yazım disiplini boşluğunu gösterir (kararlar günlüğe işlenmiyor) — bu da bulgudur.
...
- **[TSK-165] CLAUDE.md bakım sayfası — tekrarlanan ihlal → kanıtlı kural adayı; hiç tetiklenmeyen kural → sadeleştirme adayı** — status: GATED(EDG-083 GEÇTİ) · born: 2026-09-06 · owner: rol1 · size: S · trigger: EDG-2026-083 hükmü GEÇTİ (2026-09-13)
  What: Talep üzerine sayfa; her aday kural için vaka künyesi ve sayı; hiçbir kural sayfadan otomatik yazılmaz (karar operatörde/Rol-1'de, tek-kaynak yasası). Ölçüt: kabul edilen aday sayısı / toplam.
...
- **[TSK-166] Haftalık geriye bakış sayfası — "bu hafta ne değişti, ne öğrendik" (operatörün haftalık okuması)** — status: GATED(EDG-083 GEÇTİ) · born: 2026-09-06 · owner: rol1 · size: S · trigger: EDG-2026-083 hükmü GEÇTİ (2026-09-13)
  What: Pazar akşamı elle tazeleme (cron yok); kaynaklı özet; uydurma sayacı; operatör okuyucu şartı (okundu mu — bir cümle geri bildirim).
...
- **[TSK-167] docs/ anlamsal arama — pano arama kutusu LLM'siz recall (Türkçe-İngilizce karışık başlıklarda grep zayıf)** — status: QUEUED · born: 2026-09-06 · owner: rol1 · size: M · trigger: —
  What: Tasarım §4 "Pano arama kutusu: LLM'siz doğrudan recall — arşiv/karar araması"; Hafıza yüzeyinde arama kutusu, sonuçta document_id + pasaj; 132 docs .md + kartlar + günlük zaten bankada. Ölçüt: EDG-067 soru kümesiyle isabet (aynı hakem).
...
- **[TSK-168] Defter özeti besleme — haftalık strateji/kart sonuç özetlerinin (sayı + kaynak yolu) bankaya retain'i; "neyin para kazandırdığı" sorusunun DOĞRU yolu** — status: GATED(EDG-083 GEÇTİ) · born: 2026-09-06 · owner: rol1 · size: M · trigger: EDG-2026-083 hükmü GEÇTİ (2026-09-13)
  What: Yazan yalnız harness (ops betiği): karne/backtest/kart hükümlerinden haftalık kısa özet belge (document_id=hafta, blob-sha'lı), retain; sayfalar bunun üstünde "hangi hipotez tutuyor, hangisi üç kez kaldı" sentezi; her sayı defterden doğrulanır ("hatırlanan değil ölçülen"). Kart-önce.
...
- **[TSK-169] A1 gece başsız analist — Claude CLI ile taze sayfalar + defterleri okuyup bulgu sayfası yazan tek atımlık koşum** — status: GATED(bir hafta gerçek-kullanım kanıtı: ≥2 sayfa atıfı) · born: 2026-09-06 · owner: rol1 · size: M · trigger: EDG-2026-083 hükmü GEÇTİ ∧ Rol-1 günlüğünde ≥2 'kaynak: zihin modeli' atfı (2026-09-13)
  What: Operatör teklifi (2026-09-06 "A1 içerisinde Claude CLI kurup da kullanabiliriz"); bedel: sırların olduğu kutuda yeni kimlik, token, ikinci "Rol-1 sanan" oturum riski; şekil: gece `claude -p` tek atım, yan oturum kuralları (git yok, dağıtım yok), çıktı bulgu sayfası + uydurma sayacı.
