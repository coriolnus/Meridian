...
- **[TSK-066] ⑥a — mevcut sinyallerin AN yeniden-kurulumu** — status: QUEUED · born: 2026-08-31 · owner: rol1 · size: M · trigger: —
  What: (EDG-2026-079 HÜKMÜ 19:40Z: tohum defteri 885 işlemin 95'i (%10,7) işlem tarihinde S&P 500 üyesi olmayan sembolde — 42'si geç katılan (MRVL 24, APO 8, KKR 5…), 14'ü çıkış sonrası (VFC/ENPH), 39'u hiç-üye; K2 q=0,085. Bu kalem as_of(t)'yi ZORUNLU tüketici olarak alır: AN yeniden kurulumu PIT üyelikle; replay hükümleri o güne kadar survivorship şerhli. Yeniden tohumlama kartı açılacak.) (status notu 2026-09-03 gece: KART YAZILDI — EDG-2026-069, §6; ONAY 2026-09-03 sabah [K2], ölçüm kodu KOVA C sırasında.) sinyal hangi saniyede doğdu, icraya kadar fiyat ne yaptı (EDG-040 friksiyon sorusunun tick bacağı). Kartı geri-dolumun 2.-3. günü erken yazılır (PARALEL not, yukarıda).
