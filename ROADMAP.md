...
|---|---|---|---|---|---|
| **WP-E** İcra Gerçekliği | 🔴 aktif | iki-motor icra sadakati · E1 giriş · E2 slipaj defteri | ~~ayna-dolum teşhis~~ **✅ TEŞHİS BİTTİ (2026-08-10, 8 boşluk sınıfı — docs/TESHIS-WPE-AYNA-DOLUM):** koruma-ailesi #3+#4 düzeltme TURDA (Pazartesi riski); KALAN 6: #1 karar-çıkışı dolum körlüğü (~%38 kapanış, slipaj yanlı) · #2 tek-atış yaması · #5 kısmi-dolum sınıfsız · #6 fill_eq_now anakronizmi · #7 pencere boşlukları · #8 motor_yetimi kabul-yolu · E2 canlı-geçiş + E3/E4/E5 örneklem | `loop.py` · `adapters/alpaca.py` · `analytics`(cf) | EXE-2026-001(+R1/R2) · EXE-2026-002 |
