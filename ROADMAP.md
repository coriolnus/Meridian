...
| `23d` bar-içi stop varsayımı (stop slipajı SIFIR) | WP1 | **H0→H1: KART ÖN-KAYITLI `EDG-2026-045`** (K=3: stop-bacağı ek-slip {5,10,20} bps, edg040 deseni; 23b mutabakatı kartta — gerçek-dolum tarafı 042-K3'te, iki kaynaklı okuma; stop_gap'e sızma kill'de) → **İLK KOŞUM kill#1'de DURDU (2026-08-22, DOĞRU davranış):** B1 dünyası edg032b tabanını yeniden-üretilemez kıldı (6 pullback işlemi). Rol-1 kararı: YENİ TABAN edg032c donduruluyor (determinizm çift-kapılı); 045+046 ölçümden-önce yeniden çapalandı, eşik/K değişmedi. Betik hazır, taban donunca yeniden koşulur |
