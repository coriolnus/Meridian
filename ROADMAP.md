...
#### H1 — TASARIM VAR, ölçüm/uygulama bekliyor (6 kalem; **`Ö-51c` 2026-08-22'de H6 ✅'e geçti, satırı tarihçe olarak yerinde bırakıldı** → fiilen 5 açık)
...
| **`B4` E1 limit bacağı — canlıda AÇILSIN MI** | WP1 | 🆕 **BLOKE: operatör (2026-08-17)** · ⚠ ÖN-KOŞUL GÜNCELLENDİ 2026-08-22: `Ö-51c` **KAPANDI** (ΔP&L CI dördü de sıfırı içeriyor → açma gerekçesi ZAYIFLADI, güçlenmedi); geriye tek ön-koşul `Ö-51b` kaldı · `EXE-2026-006` measured → **E1 hükmü YENİDEN AÇILDI** (H1 düştü, H2 ölçülemedi) → bacağın canlıda etkisiz olmasının gerekçesi ARTIK KANITLI DEĞİL. Kart açmayı **ÖNERMEZ** (kendi sınırı) · strateji kimliği kalemi → §5 KOVA-2 · ÖN-KOŞUL: `Ö-51b` + `Ö-51c` |
