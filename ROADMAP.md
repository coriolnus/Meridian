...
- **[TSK-089] APISIX tek-kapı pilotu — LLM + veri API'leri tek kapıdan** — status: ACTIVE · born: 2026-09-01 · owner: rol1 · size: L · trigger: —
  (KAPI AÇILDI 2026-09-01 akşam — operatör: "9-10 için kur iznin var". Faz 1 KURULDU: pinli imajlar + loopback-yalnız + GitOps rota hattı + $env sırları; ölçülen dersler ve içerik-smoke borcu §7 kaydında. KALAN: Faz 1 kapanış smoke'u → NOUS_ENDPOINT çevirisi [seans-dışı] → Faz 2 FMP egress → Faz 3 pano ingress → Faz 4 bot filosu.)
...
- **[TSK-009] elle-kurulum penceresi: 5 ayrık dosya + `meridian-aylik-bucket-kopya` hiç kurulmamış** — status: DONE(2026-09-01 akşam · operatör pencere açtı, Rol-1 kurdu: 5 dosya yedekli [.bak-damgalı] + aylık-bucket service+timer kuruldu, timer armed 3 Eyl 04:03Z; AÇIK KALEM: elle test-ateşleme seans-dışı [343MB okuma I/O] — yapılmadan "çalışır" DENMEZ, yalnız "kurulu") · born: 2026-08-31 · owner: operator · size: S-M · trigger: —
