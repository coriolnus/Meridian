...
- **[EDG-2026-097] edg016-katman-ii-sagkalan-goreli-tutarlilik** — status: ACTIVE · owner: rol1 · size: — · trigger: —
  What: (ÖN-KAYIT 2026-09-15 03:14Z [Rol-1; EDG-096 ardılı]: aynı hipotez (EDG-016 ii katmanı = üyelik seçimi artefaktı), kapılar düzeltildi — A kipi ↔ PK-1 göreli fark ≤ %5 + yön/CI-0-dışılık deseni eşit (bit-eşitlik YOK: bar tabanı canlı tazelenir), katman i PK yalnız as-of ve güncel-liste kiplerinde; K=2 aynı iki kayıt. Kod: karsilastir096 kip listesi + göreli tolerans (Opus mini-dilim), sonra A1 koşumu (~30 dk).)
