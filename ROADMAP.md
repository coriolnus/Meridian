...
- **[TSK-172] refetch_max / DENSE_ATTEMPTS tek kaynağa indirme — literal 8 dört yerde (scheduler.DENSE_ATTEMPTS, api.py "refetch_max": 8, app.js `|| 8` ×2 + "8 adımlı" metni)** — status: QUEUED · born: 2026-09-06 · owner: rol1 · size: S · trigger: —
...
- **[TSK-173] Sessiz 100k özkaynak düşüşü (Alpaca yanıtı geldi ama 'equity' alanı yoksa) + DD_VETO_MARGIN'ın goal.max_drawdown/2'den türetilmesi** — status: QUEUED · born: 2026-09-06 · owner: rol1 · size: S · trigger: —
