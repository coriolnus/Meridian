...
- **[TSK-184] `regime_ok` yüklemi DÖRT kopya — `backtest.replay` · `daily_cycle` · `shadow_lifecycle._seed` · `research/olcumler/edg088_golge_pilot/pk3_selef.py` aynı ifadeyi birebir taşıyor; `regime` modülünde TEK yüklem yok** — status: ACTIVE · born: 2026-09-13 · owner: rol1 · size: S · trigger: —
