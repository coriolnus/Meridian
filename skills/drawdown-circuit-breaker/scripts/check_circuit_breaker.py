...
class CircuitConfig:
    # TEK KAYNAK = state/goal.yaml `limits.max_daily_loss_pct` (2026-07-23, tarama bulgusu). GERÇEK
    # kesici motor `meridian/health.py:circuit_breaker_tripped`'tir ve o eşiği goal.yaml'dan okur
    # (bugün 3.0). Bu skill scripti sabit 2.0 taşıyordu — motordan sürüklenmiş bir belge; operatöre
    # koddan farklı bir eşik anlatıyordu. Değer goal.yaml ile SENKRON tutulmalı (motor otoritedir).
