...
## Folded in: market-news-analyst (2026-07-30 skill audit)

`market-news-analyst` was archived to `skills/_emekli/market-news-analyst/` (not deleted): it was
bound to no pipeline, had never been called, and its news/sentiment scope is a subset of this skill —
which *is* used, pinned in both of Hermes's preload paths. Its news-impact workflow is kept here.

**Scope it added.** A 10-day sweep of market-moving events (monetary policy: FOMC/ECB/BOJ;
geopolitics and commodities; mega-cap earnings) collected via WebSearch/WebFetch, then ranked by
impact rather than by recency.

**Impact bands (measure the move, don't adjective it).**

| Market | Severe | Major | Moderate | Minor |
|---|---|---|---|---|
| Index (S&P 500 / Nasdaq 100 / Dow) | ±2%+ in a day | ±1-2% | ±0.5-1% | ±0.2-0.5% |
| Sector ETF | ±5%+ | ±3-5% | ±1-3% | <1% |
| Single mega-cap | ±10%+ (moves its index) | ±5-10% | ±2-5% | — |
| Oil (WTI/Brent) | ±5%+ | ±3-5% | ±1-3% | — |
| Gold | ±3%+ | ±1.5-3% | — | — |

**Discipline it carried.** Separate correlation from causation before naming a driver; state the
dominant narrative and the anomalies/surprises that contradict it; list upcoming catalysts and risk
scenarios rather than a single forecast.

**Boundary.** This is Hermes *context*, not a gate. Meridian's entries are decided by the
deterministic engine; a news report never arms or blocks a trade on its own.
