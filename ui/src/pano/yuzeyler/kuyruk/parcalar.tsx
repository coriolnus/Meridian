...
export function Kapi<T>({
  ...
  if (durum.veri === null) {
    // YÜKLENİYOR ile BOŞ AYRI: veri henüz yokken iskelet çizilir, "0" değil. Boş bir
    // tablo "ölçtük, hiçbir şey yok" der ve bu, istek daha dönmeden söylenmiş bir yalandır.
