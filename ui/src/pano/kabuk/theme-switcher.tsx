...
export function ThemeSwitcher() {
  ...
  const cycleTheme = () => {
    ...
    // `noUncheckedIndexedAccess` altında dizi indeksi `| undefined` döner ve bu tip
    // uyarısı burada GERÇEK bir hâli işaret ediyor: `indexOf` bulamazsa -1 döner,
    // (-1 + 1) % 3 = 0 ile yine bir eleman gelir ama dizi bir gün boşalırsa
    // `undefined` sessizce tercih deposuna yazılırdı. Varsayılan açıkça yazılıyor.
