...
- **EDG-2026-089** (`registered`) — 
  · HÜKÜM: 2026-09-13 Rol-1 — ön-kayıt; kurulum (TSK-168 retain betiği + timer + CLAUDE.md §0 okuma kuralı) bu karttan SONRA; pencere ilk başarılı retain'den itibaren
