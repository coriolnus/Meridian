# Tohum PIT yenileme — KURU (2026-09-07T08:57:59+00:00)

- araç: `ops/tohum_pit_yenile.py` · parti: `EDG-082A-2026-09-07` · varyant: A · üyelik: as_of · sv=91
- KAPI-0: uygula_izni=False (kuru koşum: yazım istenmedi (`--uygula` yok); nabız TAZE (1.675465sn < 900.0sn) — canlı worker koşuyor; tohum değişimi onun defterini altından çeker (run.replay_seed ile AYNI kapı); 1 silahlı plan var (MU) — defter değişimi o planların zeminini çeker)
...
## Yazım
- çalıştı: False — kuru koşum (`--uygula` verilmedi)
