#!/usr/bin/env python3
"""TAKİP TURU ölçüm sayfası için YEREL, GEÇİCİ statik sunucu (port 8797).

Bu klasör 08-24 turunun DONMUŞ kaydına DOKUNMAZ; kendi `sonuc.json`unu yazar.
...
HEDEF = os.path.join(KOK, "sonuc.json")
...
with socketserver.TCPServer(("127.0.0.1", 8797), Islem) as s:
    s.serve_forever()
