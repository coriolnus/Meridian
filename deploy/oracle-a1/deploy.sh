...
if [ -d "$SEF_PROFIL" ]; then
  ...
  echo "        (BOT_KEY_SEF — profilin KENDİ .env'i; dağıtım ona ASLA dokunmaz)"
  echo "        ANAHTAR ADI DEĞİŞTİ (TSK-105): bot kapıya gider, OpenRouter'a değil. Değer"
  echo "        kapının bot_sef tüketicisiyle AYNI olmalı (routes.yaml \$env://BOT_KEY_SEF);"
  echo "        ayrışırsa kapı 401 döner ve brifing SESSİZCE ham gider."
...
if [ -d "$BEKCI_PROFIL" ]; then
  ...
  echo "        (BOT_KEY_BEKCI — profilin KENDİ .env'i; dağıtım ona ASLA dokunmaz)"
  echo "        ANAHTAR ADI DEĞİŞTİ (TSK-105): bot kapıya gider, OpenRouter'a değil. Değer"
  echo "        kapının bot_bekci tüketicisiyle AYNI olmalı (routes.yaml \$env://BOT_KEY_BEKCI);"
  echo "        ayrışırsa kapı 401 döner ve liste SESSİZCE ham gider."
...
if [ -d "$KARNE_PROFIL" ]; then
  ...
  echo "        (BOT_KEY_KARNE — profilin KENDİ .env'i; dağıtım ona ASLA dokunmaz)"
  echo "        ANAHTAR ADI DEĞİŞTİ (TSK-105): bot kapıya gider, OpenRouter'a değil. Değer"
  echo "        kapının bot_karne tüketicisiyle AYNI olmalı (routes.yaml \$env://BOT_KEY_KARNE);"
  echo "        ayrışırsa kapı 401 döner ve karne SESSİZCE ham gider."
