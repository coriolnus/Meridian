...
const N = [
 ...
 {id:"rgm",   t:"proc",   x:790,y:345, ic:"🌡️",lb:"P1 · Rejim + bütçe",sb:"eşik + chop bütçesi · state/strategy.yaml",
  tip:"Endeksten rejim (trend_up/chop/…) ve maruziyet bütçesi. Rejim eşiği ve sürüm SAYIYLA YAZILMAZ (bu sayfa 2026-07-20'den beri bayattı: 'v4 · eşik 40→20' derken defterde v5 · eşik 40 vardı) — yürürlükteki değer state/strategy.yaml (version, regime.min_exposure_score) ve panonun canlı kartıdır."},
 ...
 {id:"scan",  t:"proc",   x:430,y:470, ic:"🔍",lb:"P2 · Tarama",sb:"4 ekran: VCP·pullback·burst·EP",
  tip:"Evren boyu SAYIYLA YAZILMAZ (bu satır '250 … bugün' derken 'bugün' 2026-07-21'e aitti ve evren 2026-07-30'da değişmişti) — yürürlükteki evren adapters/data.py REPLAY_UNIVERSE ve /api/market'tir. Her sembolde 4 ekran birden değerlendirilir."},
 ...
 {id:"dorm",  t:"dec",    x:430,y:730, ic:"🌱",lb:"Uyuyan kurulum mu?",sb:"yalnız keşif yolu",
  tip:"momentum_burst 2026-08-12 pencere kararıyla TAM SİLAHLANDI (EDG-025/032 ölçümleri; artık normal yoldan gider — exhaustion_hammer emsali). Kalan uyuyan ateşlemeler (ör. episodic_pivot) plan olur ve kapıdan geçer ama GO alsalar bile YALNIZ keşif sondası (0.25R) olarak silahlanabilir. Tam silahlanma kararı ölçüm kartı + operatör penceresinin."},
 {id:"arm",   t:"proc",   x:300,y:860, ic:"🎯",lb:"Normal silahlanma",sb:"bütçe>0 · 20 slot · 0.5R taban",
  tip:"GO/REVIEW planlar açık slot varsa bir sonraki açılış için silahlanır (0.5R taban boyut; dereceli risk-azaltma rampası 15/36 artık goal-kablolu — 2026-08-12 C-paketi: slot 20, ısı zarfı 5R bağlayıcı). Chop bütçesi artık %25 → bu yol chop'ta yeniden açık."},
