...
(function () {
  ...
  function stilEnjekteEt() {
    ...
    st.textContent = [
      ...
      "  background:var(--card);border:1px solid var(--line);border-radius:var(--r-card);overflow:hidden;box-shadow:var(--elev)}",
      ".mrdp-bar{display:flex;align-items:center;gap:var(--s3);padding:var(--s3) var(--s4);border-bottom:1px solid var(--line);background:var(--bg2)}",
      ...
      ".mrdp-yaz{font-family:var(--mono);font-size:var(--label-size);letter-spacing:.04em;text-transform:uppercase;",
      "  color:var(--amber);border:1px solid var(--amber-h);border-radius:var(--r-bar);padding:1px 5px}",
      ".mrdp-ipucu{font-family:var(--mono);font-size:var(--t-cap);color:var(--tx2);border:1px solid var(--line);",
      ...
      "  border-top:1px solid var(--line);background:var(--bg2);font-family:var(--mono);font-size:var(--t-cap);color:var(--tx2)}",
      /* --- iki adımlı onay --- */
      ...
      "  border-radius:var(--r-ctl);border:1px solid var(--line);background:transparent;color:var(--tx);cursor:pointer}",
